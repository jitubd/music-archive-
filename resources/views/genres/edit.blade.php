...
@section('content')
<div class="max-w-lg">
    <form action="{{ route('genres.update', $genre) }}" method="POST" class="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6 space-y-4">
        @csrf @method('PUT')
        <div>
        ...
        <div class="flex items-center gap-3 pt-2">
            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-5 py-2.5 rounded-lg transition">Update Genre</button>
